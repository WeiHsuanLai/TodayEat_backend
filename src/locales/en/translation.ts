export default {
    ...
    "測試鑰匙": "test_key",
    "測試成功":"test_success",
    "未知請求將導向外部網址":"OIIA OIIA",
    "[全域錯誤]":"[Global Error]",
    "未知錯誤":"Unknown Error",
    "❌ 缺少環境變數 DB_URL":"❌ Missing environment variable: DB_URL",
    "✅ 資料庫連線成功":"✅ 資料庫連線成功",
    ...
    "此帳號已存在": "This account already exists",
    ...
    "此 token 已被取代，請重新登入": "This token has been superseded. Please log in again.",
    "token 已過期，請重新登入": "Token has expired. Please log in again.",
    "token 驗證失敗": "Token verification failed."
}